submodule (basis_cc) basis_cc_pv6z
  implicit none

contains

  module subroutine get_cc_basis_pv6z(basis_data, element_number, ilast)
  ...
  end subroutine get_cc_basis_pv6z

end submodule basis_cc_pv6z