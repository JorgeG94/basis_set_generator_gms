submodule (basis_aug_cc) basis_aug_cc_pv6z
  implicit none

contains

  module subroutine get_aug_cc_basis_pv6z(basis_data, element_number, ilast)
  ...
  end subroutine get_aug_cc_basis_pv6z

end submodule basis_aug_cc_pv6z