submodule (basis_pople_631) basis_pople_631_6_31plusplusgstarstar
  implicit none

contains

  module subroutine get_pople_631_basis_6_31plusplusgstarstar(basis_data, element_number, ilast)
  ...
  end subroutine get_pople_631_basis_6_31plusplusgstarstar

end submodule basis_pople_631_6_31plusplusgstarstar