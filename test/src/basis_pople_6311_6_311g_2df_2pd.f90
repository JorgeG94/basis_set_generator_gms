submodule (basis_pople_6311) basis_pople_6311_6_311g_2df_2pd
  implicit none

contains

  module subroutine get_pople_6311_basis_6_311g_2df_2pd(basis_data, element_number, ilast)
  ...
  end subroutine get_pople_6311_basis_6_311g_2df_2pd

end submodule basis_pople_6311_6_311g_2df_2pd