submodule (basis_pople_631) basis_pople_631_6_31plusplusgstar
  implicit none

contains

  module subroutine get_pople_631_basis_6_31plusplusgstar(basis_data, element_number, ilast)
  ...
  end subroutine get_pople_631_basis_6_31plusplusgstar

end submodule basis_pople_631_6_31plusplusgstar