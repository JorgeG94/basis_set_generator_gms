...
def json_to_gamess_fortran_modular(basis_names, elements=None, base_subroutine_name="get_ccn_dk_basis"):
    ...
    for n_zeta_idx, basis_name in enumerate(basis_names, start=1):
        ...
        worker_code = generate_worker_subroutine(
            basis_name, basis_const_name, worker_name, 
...
def generate_worker_subroutine(basis_name, basis_const_name, subroutine_name, elements, basis_dict):
...
def generate_driver_subroutine(base_name, elements, basis_names):
...
if __name__ == "__main__":
    ...
    fortran_code = json_to_gamess_fortran_modular(basis_sets)
